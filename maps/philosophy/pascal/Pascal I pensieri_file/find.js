...
var strShapeName	= "Nome forma";
var strShapeText	= "Testo forma";
var strProps		= "Proprietà forma";
var strResults		= "Risultati ricerca per:";

var strShape	= "Nome forma:";
var strNoCustomPropertiesToDisplayText = "Per visualizzare i dettagli, fare clic su una forma del disegno tenendo premuto CTRL.";
...
function FindOnClick()
{
	...
	if (searchTokensArray.length > 0)
	{
		...
		var strResultsHTML = "Non è stata trovata alcuna corrispondenza.";
		var lastPageID = null;
		var shapeID;
		...
		if(ArrayLength > 0)
		{
			...
			for ( count = 0; count < ArrayLength; count++)
			{
				...
				strResultsHTML += '<p class="results"><a href="javascript:populateSearchResultDetails(\'results_'+ lastPageID +'_'+ shapeID +'\', '+ lastPageID +','+ shapeID +'); TogglePlus(\'results_' + lastPageID + '_' + shapeID + '\',\'img_' + lastPageID + '_' + shapeID + '\', hideResults)"><img src="plus.gif" style="padding-left:13px" alt="Mostra/nascondi dettagli forma" width="13" height="9" border="0" id="img_'+ lastPageID +'_'+ shapeID +'"></a>\n'
