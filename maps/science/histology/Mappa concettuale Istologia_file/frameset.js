...
var xmlData = XMLData("Mappa concettuale Istologia_file/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='Tabella contenente i dettagli della forma'>";
		strStartTable += "<THEAD class='propViewerTHEAD'><TH>Etichetta</TH><TH>Valore</TH></THEAD>";
	...
	if (shapeNode != null)
	{
		...
		{
			strCPHTML = "Dettagli non disponibili.";
		}
	}
